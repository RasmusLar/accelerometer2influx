        ...
        if (buffer.size >= sendBufferSize) {
            ...
            for (i in 0..sendBufferSize-1) {
                ...
                val point = Point.measurement("accelerometer")
                        ...
                        .addField("ax", state.acceleration[0])
                        .addField("ay", state.acceleration[1])
                        .addField("az", state.acceleration[2])
                        .addField("vx", state.speed[0])
                        .addField("vy", state.speed[1])
                        .addField("vz", state.speed[2])
                        .build()
